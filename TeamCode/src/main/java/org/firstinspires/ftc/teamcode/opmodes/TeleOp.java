...
public class TeleOp extends LinearOpMode {
    ...
    double dtspeed = 1;
    public double up = 1150;
    public double mid = 700;
    public double low = 350;
    public double ground = 0;
    public double idle = 200;
    public double intaking = 20;
    ...
    private double horizontalback = 0.52;
...
//            double correctedpitch = robot.drive.getOrientation().thirdAngle + 3.13;
            ...
            switch (robotMode) {
                case NORMAL:
                    ...
                    switch (robotState) {
                        ...
                        case INTAKING:
                            ...
                            switch (fallenCone) {
                                case Lifted:
                                    robot.intake.liftFallen();
                                    if (armtimer.milliseconds() > 500) {
                                        fallenCone = fallenCone.Dropped;
                                        armtimer.reset();
                                    }
                                case Dropped:
                                    robot.intake.dropFallen();
                                    if (armtimer.milliseconds() > 500) {
                                        fallenCone = fallenCone.Lifted;
                                        armtimer.reset();
                                    }
                            ...
                            if (timer2.milliseconds() > 500) {
                                robot.intake.openClaw();
                                if (timer.milliseconds() > 500) {
                                    if (gamepad1.left_bumper || gamepad2.left_bumper || robot.intake.getDistance() < 3) {
                                        robot.intake.closeClaw();
                                        robot.intake.stopIntake();
                                        fallenCone = fallenCone.Lifted;
                ...
                case STACK:
                    ...
                    if (robotState == robotState.INTAKING && gamepad2.right_bumper) {
                        robot.lift.setTargetHeight(100);
                    }
                    if (robotState == robotState.INTAKING && gamepad2.left_bumper) {
                ...
                case AUTOCYCLE:
                    ...
                    if (running == true) {
                        if (autotimer.milliseconds() < 300) {
                            robot.lift.setTargetHeight(30);
                            robot.turret.MAX_POWER = 0.5;
                            robot.intake.setArmPos(0.44);
                            robot.intake.fullyOpenClaw();
                            robot.lift.setHorizontalPosition(horizontalextended);
                        }else if(autotimer.milliseconds()>400 && autotimer.milliseconds()<900) {
                            robot.intake.closeClaw();
                        }else if(autotimer.milliseconds()>900 && autotimer.milliseconds()<2000)    {
                            robot.lift.setTargetHeight(up);
                            robot.intake.setArmPos(0.6);
                            robot.lift.setHorizontalPosition(horizontalback);
                            robot.turret.setTargetAngle(680);
                        }else if (autotimer.milliseconds()>2000 && autotimer.milliseconds()<2500){
                            robot.lift.setHorizontalPosition(0.7);
                        }else if (autotimer.milliseconds()>2500 && autotimer.milliseconds()<2700){
                            robot.lift.setTargetHeight(up-200);
                        }else if(autotimer.milliseconds()>2700){
                            robot.intake.openClaw();
//                            robot.lift.setTargetHeight(30);
                        }
                    }
