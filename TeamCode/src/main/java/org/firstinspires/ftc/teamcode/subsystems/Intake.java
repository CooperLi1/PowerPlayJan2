...
public class Intake implements Subsystem {
    ...
    //Fallen Cone constants
    private double droppedfallen = 0.5;
    private double liftedfallen = 0.2;
    ...
    public Intake(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        fallenConeServo = hardwareMap.get(Servo.class, "fallencone");
    ...
    public void dropFallen(){
        fallenConeServo.setPosition(droppedfallen);
    }

    public void liftFallen(){
        fallenConeServo.setPosition(liftedfallen);
    }
