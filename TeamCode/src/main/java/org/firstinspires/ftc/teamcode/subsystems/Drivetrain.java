...
//        }
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        if (voltagemode == "auto") {
            ...
            leftFront.setPower(v * voltagecompmultiplier);
            leftRear.setPower(v1 * voltagecompmultiplier);
            rightRear.setPower(v2 * voltagecompmultiplier);
            rightFront.setPower(v3 * voltagecompmultiplier);
